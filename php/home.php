...
<body>
  <div id="main">
    ...
    <section id="maping">
      <h1></h1>
      <div class="maping__content">
        <div class="nearRes col col-half">
          <h1 class="text-center">Quán ăn gần bạn</h1>
          <div class="nearRes__box">
            <div class="nearRes__box--child">
              <div class="km mg-12">
                <b class="fz-28">1.5</b> <br />
                <p style="margin-top: -8px" class="text-center">km</p>
              </div>
              <div class="tagname mg-12">
                <b class="fz-24">Quán chay Phước Ngân</b>
                <p>23 Công chúa Ngọc Hân, P13, Q11, TpHCM</p>
              </div>
            </div>
            <div class="nearRes__box--child">
              <div class="km mg-12">
