  ...
  <div class="container" id="container">
    <div class="form-container sign-up-container">
      <form action="./include/signup.inc.php" class="form" id="form-1" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" name="fullname" id="fullname" class="form-control" placeholder="Tên đăng nhập..." />
          <span class="form-message"></span>
        </div>
        <div class="form-group">
          <label class="input-label" for="email">Email</label>
          <input type="email" name="email" id="email" class="form-control" placeholder="yourname@vega.network" />
          <span class="form-message"></span>
        </div>
        <div class="form-group">
          <label class="input-label" for="password">Mật khẩu</label>
          <input type="password" name="password" id="password" class="form-control" placeholder="Nhập mật khẩu tại đây" />
          <span class="form-message"></span>
        </div>
        <div class="form-group">
    ...
    <div class="form-container sign-in-container">
      <form action="./include/login.inc.php" class="form" id="form-2" method="POST">
        ...
        <div class="form-group">
          <label class="input-label" for="email">Email</label>
          <input type="email" id="email-signin" class="form-control" name="email" placeholder="yourname@vega.network" />
          <span class="form-message"></span>
        </div>
        <div class="form-group">
          <label class="input-label" for="password">Mật khẩu</label>
          <input type="password" id="password-signin" class="form-control" name="password" placeholder="Nhập mật khẩu tại đây" />
          <span class="form-message"></span>
        </div>
        <div class="form-group">
          <label for="checkbox-sub" class="checkbox-style">
            <input type="checkbox" name="checkbox" id="checkbox-sub" class="checkbox-input" />
            <div class="checkbox-box">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
              </svg>
            </div>
            <label for="checkbox-sub" class="checkbox-label" id="checkbox-signin" name="remember-me">
              Hãy nhớ tôi
